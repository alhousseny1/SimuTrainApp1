...
namespace SimuTrainApp.Controllers
{
    public class StationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Place")] Station station)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Place")] Station station)
        {
            if (id != station.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBContext.Station'  is null.");
            }
            var station = await _context.Station.FindAsync(id);
            if (station != null)
            {
